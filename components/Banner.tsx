          ...
          <div className="md:w-1/2 text-left mt-8 md:mt-0">
            ...
            <div className="mt-8 text-center md:text-left flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-4">
              ...
              <div className="flex flex-wrap justify-center md:justify-start space-x-4 md:space-x-4 space-y-4 md:space-y-0 mt-2 md:mt-0 items-center pt-2">
                ...
                <Link href="https://x.com/WilAI1624" target="_blank" className="transition duration-300 ease-in-out transform hover:scale-110 hover:text-purple-600">
                  <FontAwesomeIcon icon={faXTwitter} className="h-8 w-8 text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-500" />
                </Link>
                <Link href="https://www.tiktok.com/@wilfredososaai" target="_blank" className="transition duration-300 ease-in-out transform hover:scale-110 hover:text-purple-600">
                  <FontAwesomeIcon icon={faTiktok} className="h-8 w-8 text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-500" />
                </Link>
                <Link href="https://www.reddit.com/user/Legitimate-Tooth5891/" target="_blank" className="transition duration-300 ease-in-out transform hover:scale-110 hover:text-purple-600">
                  <FontAwesomeIcon icon={faReddit} className="h-8 w-8 text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-500" />
                </Link>
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 p-6 rounded-lg shadow-lg flex items-center hover:scale-105 transition-transform duration-300">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-200">+1 year of professional experience in US companies</h3>
                </div>
              </div>
              <div className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 p-6 rounded-lg shadow-lg flex items-center hover:scale-105 transition-transform duration-300">
                <Code className="h-12 w-12 text-purple-600 dark:text-purple-400" />
                <div className="ml-4">
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-200">+100 Software and AI Engineering projects</h3>
                </div>
              </div>
            </div>
          </div>
